...
class Solver():
    def __init__(self, numberOfProducts, numberOfTruckTypes,
                 prob, productVolumes, productDemandQuantity,
                 truckTypeCapacities, numberOfTrucksPerType):
        self.prob = prob
    ...
    def getSolution(self):
        ...
        self.prob += (lpSum([y[truckPerType] for truckPerType in self.getTrucksPerTypeNames()]),
